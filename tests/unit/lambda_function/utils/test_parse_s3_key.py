...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "raw/proj-123-uuid/doc-999.png",
            "images",
            "doc-999",
            ".jpg",
            "projects/images/proj-123-uuid/doc-999.jpg",
        ),
        (
            "raw/proj-123-uuid/contract.pdf",
            "documents",
            "contract",
            ".pdf",
            "projects/documents/proj-123-uuid/contract.pdf",
        ),
        (
            "raw/proj-123-uuid/photo.JpeG",
            "images",
            "photo",
            ".jpg",
            "projects/images/proj-123-uuid/photo.jpg",
        ),
        (
            "raw/proj-123-uuid/asset.jfif",
            "images",
            "asset",
            ".jpg",
            "projects/images/proj-123-uuid/asset.jpg",
        ),
    ],
)
def test_parse_s3_key_valid_cases(
    s3_key, expected_category, expected_doc_id, expected_ext, expected_final_key
):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "projects/images/proj-123-uuid/photo.jpg",
            "Path 'projects/images/proj-123-uuid/photo.jpg' does not match expected landing prefix.",
        ),
        (
            "raw/proj-123-uuid/subfolder/file.pdf",
            "Path 'raw/proj-123-uuid/subfolder/file.pdf' does not match expected landing prefix.",
        ),
