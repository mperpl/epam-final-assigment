...
class TestS3KeyGenerator:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                ".pdf",
                "projects",
                "projects/documents/p1/doc-file.pdf",
            ),
            (
                "p1",
                "doc-file",
                ".DoCx",
                "projects",
                "projects/documents/p1/doc-file.docx",
            ),
            ("p1", "d1", ".png", "archive", "archive/images/p1/d1.jpg"),
        ],
    )
    def test_s3_key_generator_success(
        self, project_id, document_id, file_extension, base_folder, expected_path
    ):
    ...
    def test_s3_key_generator_invalid_extensions(self, invalid_extension):
        ...
        with pytest.raises(DataIntegrityError) as exc_info:
            s3_key_generator(
                project_id="p1", document_id="d1", file_extension=invalid_extension
            )
