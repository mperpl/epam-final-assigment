...
async def delete_project_service(project_id: UUID, user_id: UUID, db: AsyncSession, s3_client: S3Client) -> None:
    ...
    try:
        ...
        await delete_folder_s3(settings.S3_BUCKET, f"projects/images/{project_id}/", s3_client)
        await delete_folder_s3(settings.S3_BUCKET, f"projects/documents/{project_id}/", s3_client)
